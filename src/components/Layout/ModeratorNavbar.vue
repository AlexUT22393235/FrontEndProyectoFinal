    ...
    <div class="flex  justify-between ">
      ...
      <div class="w-[70rem] flex flex-row gap-[2rem]">
        <div class="w-full px-10 ">
          <!-- Menú de navegación -->
          <nav class="flex items-center flex-row justify-evenly h-full">
            <RouterLink to="/moderator/users"><label class="text-green-800 hover:text-teal-600 cursor-pointer">Moderar usuarios</label></RouterLink>
            <RouterLink to="/moderator/products"><label class="text-green-800 hover:text-teal-600 cursor-pointer">Moderar Productos</label></RouterLink>
          </nav>
        </div>
